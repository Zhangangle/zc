...
public class ChatListViewFooter extends LinearLayout{
	...
	public ChatListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setText(R.string.str_pull_footer_hint_ready);
		} else if (state == STATE_LOADING) {
			mProgressBar.setVisibility(View.VISIBLE);
		} else {
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.str_pull_footer_hint_normal);
		}
	}
	...
	private void initView(Context context) {
		mContext = context;
		LinearLayout moreView = (LinearLayout)LayoutInflater.from(mContext).inflate(R.layout.chatlistview_footer, null);
		addView(moreView);
		...
		mContentView = moreView.findViewById(R.id.relayout_footer_content);
